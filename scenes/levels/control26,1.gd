...
@export var next_scene_path: String = "res://scenes/levels/26,2.tscn"

var dialogues = [
	{"speaker": "Розария", "text": "Мне нужно поговорить с ним "},
	{"speaker": "Адам", "text": "Не сейчас, он в ярости"},
	{"speaker": "Розария", "text": "...Хорошо"},
