...
@export var next_scene_path: String = "res://scenes/levels/21,5.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"speaker": "Розария", "text": "Это был спор. Моя бывшая подруга сказала, что я не посмею. А я посмела. Разбила"},
 {"speaker": "Розария", "text": "А потом, когда очнулсь в этой академии...поняла"},
 {"speaker": "Розария", "text": "Что настоящую отцовскую машину я продала за месяц до этого "},
 {"speaker": "Розария", "text": "Чтобы купить машину для того парня, который меня бросил"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,4.tscn")
	show_current_line()
