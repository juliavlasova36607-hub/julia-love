...
@export var next_scene_path: String = "res://scenes/levels/21,4.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Зак показывает на экран "},
 {"speaker": "Зак", "text": "Я нашёл твоё дело. Ты угнала Porsche 911 Turbo S. Не skyline. Почему?"},
 {"speaker": "Розария", "text": "В моменте все замирает внутри, как будто на мгновенье стало пусто внутри..."},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,3.tscn")
	show_current_line()
