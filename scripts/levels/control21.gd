...
@export var next_scene_path: String = "res://scenes/levels/21,1.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Ночь. Секретный гараж. Зак и Розария  работают над skyline"},
 {"name": "", "text": "Зак, не поворачиваясь говорит Розарии "},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21.tscn")
	show_current_line()
