...
@export var next_scene_path: String = "res://scenes/levels/21,15.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Он достаёт из заднего кармана лист А4"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,14.tscn")
	show_current_line()
