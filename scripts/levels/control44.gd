...
@export var next_scene_path: String = "res://scenes/levels/4.tscn"

var dialogues = [
	{"name": "", "text": "Моя комната показывает все чувства внутри меня"},
	{"name": "", "text": "недавно во сне мне приснилась женщина"},
	{"name": "", "text": "Она была похоже на меня"},
	{"name": "", "text": "...Я думаю это была моя мать"},
	{"name": "", "text": "Исходя из сна она умерла"},
	{"name": "", "text": "...Оставив лишь кольца"},
]

var current_index = 0

func _ready():
	GameManager.set_current_scene("res://scenes/levels/3.tscn")
	if dialog_text == null:
