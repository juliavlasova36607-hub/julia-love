...
@export var next_scene_path: String = "res://scenes/levels/21,18.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"speaker": "Розария", "text": "Не надо. Я сама разберусь"},
 {"name": "", "text": "Она смотрит прям на Криса"},
 {"speaker": "Розария", "text": "Ты сказал, что хочешь, чтобы я знала. Я знаю. А теперь уходи"},
 {"name": "", "text": "Крис смотрит на неё долго. Впервые в его глазах не пустота. Что-то похожее на..."},
 {"name": "", "text": "Уваженеие? Или сожаление.. "},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,17.tscn")
	show_current_line()
