...
@export var next_scene_path: String = "res://scenes/levels/29.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Розария молча подходит к столу"},
 {"speaker": "Зак", "text": "Ты влюбилась в убийцу твого отца. Ты это понимаешь? Он сын человка, который разрушил твою жизнь"},
 {"speaker": "Розария", "text": "Он не его отец"},
 {"speaker": "Зак", "text": "А ты не его мать. Ты девочка, которая сбегает. Решай. Мы или он. Одного выбора нет"},
