...
@export var next_scene_path: String = "res://scenes/levels/21,12.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"speaker": "Крис", "text": "Они вместе гоняли по трассе, котоую потом залили бетоном"},
 {"speaker": "Крис", "text": "Твой старик учил моего не бояться скорости. А потом мой старик убил твоего"},
 {"name": "", "text": "Тишина. Зак замер"},
 {"speaker": "Розария", "text": "что..."},
 {"speaker": "Крис", "text": "Заказное. Твой отец видел то, что не должен был. Мой отец был киллером. Они дружили"},
 {"speaker": "Крис", "text": "И к сожалению не было выбора, кроме того, как его убить"},
 {"name": "", "text": "Розария, молча села в машину и..."},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,10.tscn")
	show_current_line()
