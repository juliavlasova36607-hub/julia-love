...
@export var next_scene_path: String = "res://scenes/levels/5.tscn"

var dialogues = [
	{"name": "", "text": "В свободное время от учёбы, я зависаю в гараже..."},
	{"name": "", "text": "Его можно получить с временной машиной "},
	{"name": "", "text": "Да... я забыла сказать наша академия связан с техникой"},
	{"name": "", "text": "Для тех, у кого высокая репутация, те могут получить личную машину, во время учёбы, даже тнинговать"},
