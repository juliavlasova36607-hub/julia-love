...
@export var next_scene_path: String = "res://scenes/levels/22,9.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [

 {"speaker": "Розария", "text": "Кто бы это не был... спасибо"},
 {"speaker": "Розария", "text": "Я отложила записку с шоколадкой"},
 {"speaker": "Розария", "text": "И задумалась..."},
 {"speaker": "Розария", "text": "А от этого начала засыпать..."},
