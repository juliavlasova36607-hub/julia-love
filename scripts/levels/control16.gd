...
@export var next_scene_path: String = "res://scenes/levels/17.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Розария смотрит им вслед. Сердце почему-то ёкнуло..."},
 {"speaker": "Розария", "text": "Я задумалась, в голове мелькнули мысли Кто этот... с красным глазом? Почему он меня игнорирует? Мне же плевать. Мне правда плевать... "},
 {"speaker": "Розария", "text": "Нет, не плевать..."},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/16.tscn")
	show_current_line()
