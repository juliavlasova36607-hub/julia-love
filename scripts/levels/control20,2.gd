...
@export var next_scene_path: String = "res://scenes/levels/20,3.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Вмешивается Рэй"},
 {"speaker": "Рэй", "text": "Адам . Прекрати. Твоя грубость оскорбляет мои уши"},
 {"speaker": "Адам", "text": "Это не твоё дело псих"},
 {"speaker": "Рэй", "text": "Теперь моё. Розария не твоя игрушка"},
 {"speaker": "Рэй", "text": "Она редкий цветок в этом болоте. Не прикосайся к ней"},
 {"name": "", "text": "Адам, развернулся и ушёл"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/20,2.tscn")
	show_current_line()
