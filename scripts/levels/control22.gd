...
@export var next_scene_path: String = "res://scenes/levels/22,1.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
  
 {"name": "", "text": "Розария сидит в карцере. Холодный бетонный пол. Ведро в углу. Лампочка жужжит над головой"},
 {"speaker": "Розария", "text": "Как меня подставили"},
 {"speaker": "Розария", "text": "В моей тумбочке нашли украденные свечи зажигания"},
 {"speaker": "Розария", "text": "Но я знаю, кто это сделал..."},
 {"speaker": "Розария", "text": "Это была Вария, покка я была  в душе она подкинула мне эти свечи зажигания"},
 {"name": "", "text": "Дверь карцера открывается. Заходит Элиас"},
