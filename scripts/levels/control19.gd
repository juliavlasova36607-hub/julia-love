...
@export var next_scene_path: String = "res://scenes/levels/20.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "В нашей академии есть одна большая комната где проходит занятие по баллитике"},
 {"name": "", "text": "Неделю спустя..."},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/19.tscn")
	show_current_line()
