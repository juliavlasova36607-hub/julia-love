...
@export var next_scene_path: String = "res://scenes/levels/21,6.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"speaker": "Зак", "text": "Не важно, что ты сделала. Важно, что ты сделаешь теперь"},
 {"speaker": "Зак", "text": "Почини skyline и там дальше будет видно, какие будут действия в дальнейшем"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,5.tscn")
	show_current_line()
