...
@export var next_scene_path: String = "res://scenes/levels/22,8.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [

{"name": "", "text": "Она берёт шоколадку и записку"},
{"name": "", "text": "В этой записке написанно"},
{"name": "", "text": "Не сдыхай. Ты нужна мне живой. - К."},
{"name": "", "text": "Сердце пропускает удар. К. Крис? Или Кай?"},
{"name": "", "text": "Почерк грубый, торопливый. Еле разобрать"}
