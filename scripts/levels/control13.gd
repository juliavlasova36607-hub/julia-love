...
@export var next_scene_path: String = "res://scenes/levels/14.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Мастерская. Огромный ангар. Пол в масле и охлаждающей жидкости"},
{"name": "", "text": "На цепях  висят двигатели"},
{"name": "", "text": " В углу стоит сварка"},
