...
@export var next_scene_path: String = "res://scenes/levels/24,2.tscn"

var dialogues = [
	{"name": "", "text": "Розария в моменте замират, а Вария, что то сказала Розарии про Криса, но Розария настолько задумалась о Крисе"},
	{"name": "", "text": "Вария уходит, подсаживается рядом Кай"},
