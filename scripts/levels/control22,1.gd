...
@export var next_scene_path: String = "res://scenes/levels/22,2.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
  
 {"speaker": "Элиас", "text": "12 часов за кражу. Ты признаёшь вину?"},
 {"speaker": "Розария", "text": "Я ничего не крала. Это подстава..."},
 {"speaker": "Элиас", "text": "Доказательства?"},
 {"speaker": "Розария", "text": "Посмотри камеры"},
 {"speaker": "Элиас", "text": "Камеры в душевой нет. А тумбочка вне зоны образа. Ты это знаешь "},
 {"name": "", "text": "Он садится на корточки, чтобы быть с ней на одном уровне "},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/22,1.tscn")
	show_current_line()
