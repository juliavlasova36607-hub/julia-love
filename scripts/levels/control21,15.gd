...
var dialogue = [
 {"name": "", "text": "Крис положил документы на багажник машины и отошёл"},
 {"speaker": "Крис", "text": "Читай. Отчёт о ликвидации. Объект Евгений (твой отец). Заказчик - скрыт. Исполнитель Риот (отец Криса). Подпись"},
 {"speaker": "Крис", "text": "Печать. Всё по закону. Законам убийц"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,15.tscn")
	show_current_line()
