...
var dialogue = [
  {"speaker": "Розария", "text": "Мы свободны"},
  {"speaker": "Крис", "text": "Нет. Теперь начинается самое сложное. Жизнь за пределами"},
  {"speaker": "Розария", "text": "Я справлюсь, я чинила skyline. Я чинила себя. Починю и жизнь"},
