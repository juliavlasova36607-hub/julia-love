...
@export var next_scene_path: String = "res://scenes/levels/21.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Что ему нужно? Почему он меня защищает? "},
 {"name": "", "text": "И почему от его голоса мурашки... но не такие, как от Криса"},
 {"speaker": "Розария", "text": "Я немного повернулась, чтобы псмотреть что делает Крис, Вария шепчет что-то ему на ухо, а он не реагирует никак"},
 {"speaker": "Розария", "text": "И вдруг он резко перекидывает взгляд прям на меня"},
 {"speaker": "Розария", "text": "В его взгляде ничего, кроме пустоты"}, 
 {"speaker": "Рэй", "text": "Я отвожу взгляд первой и тихо вздыхаю..."},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/20,4.tscn")
	show_current_line()
