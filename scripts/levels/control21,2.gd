...
@export var next_scene_path: String = "res://scenes/levels/21,3.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"speaker": "Розария", "text": "А ты умник?"},
 {"speaker": "Зак", "text": "Я реалист. Чтобы выжить здесь, нужно нарушать правила"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,2.tscn")
	show_current_line()
