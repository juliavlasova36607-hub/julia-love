...
@export var next_scene_path: String = "res://scenes/levels/30,2.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "2:58 ночи. Рядос мостом стоит охрана"},
 {"name": "", "text": "Skyline вылетает из гаража. За рулём Розария. Рядом Крис"},
