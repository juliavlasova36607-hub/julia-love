...
@export var next_scene_path: String = "res://scenes/levels/21,14.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Она посмотрела на Криса"},
 {"speaker": "Розария", "text": "Ты врешь. Ты просто хочешь меня раздавить, как все здесь..."},
 {"speaker": "Крис", "text": "Я не вру. И мне плевать, веришт ты или нет"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,13.tscn")
	show_current_line()
