...
@export var next_scene_path: String = "res://scenes/levels/25,3.tscn"

var dialogues = [
	{"name": "", "text": "Розария смотрит в его глаза"},
	{"speaker": "Розария", "text": "Почему ты такой...противоречный? Ты то спасаешь, то уничтожаешь"},
	{"speaker": "Крис", "text": "Потому что я сын убийцы. И я не знаю, как быть другим "},
	{"name": "", "text": ""},
	{"speaker": "Крис", "text": ""},
