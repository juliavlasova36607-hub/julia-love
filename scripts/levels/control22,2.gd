...
@export var next_scene_path: String = "res://scenes/levels/22,3.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
  
 {"speaker": "Элиас", "text": "Я знаю, что это не ты. Но правила есть правила."},
 {"speaker": "Элиас", "text": "Ты здесь для того, чтобы научиться выживать в системе, где тебя будут топить"},
 {"speaker": "Элиас", "text": "Сейчас ты учишься"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/22,2.tscn")
	show_current_line()
