...
@export var next_scene_path: String = "res://scenes/levels/21,10.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Он отпускает её. Отходит к skyline. Проводит рукой по крылу машины "},
 {"speaker": "Крис", "text": "R34. Хорошая тачка. Я знаю, кто её собрал"},
 {"speaker": "Крис", "text": "Твой отец работал с моим"},
 {"name": "", "text": "Розария замирает"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,9.tscn")
	show_current_line()
