...
@export var next_scene_path: String = "res://scenes/levels/16.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Она берёт шоколадку и клалет в карман"},
 {"name": "", "text": "Из тени выходит Вария и Крис. Он не смотрит на Розарию вообще"},
 {"speaker": "Вария", "text": "Смотрите, наша подводница очухалась. Розария,да? Красивое имя. Для трупа"},
 {"speaker": "Розария", "text": "А ты, видимо, местная стерва. Приятно познакомится. Таких как ты я через одну била"},
 {"name": "", "text": "В гараже тишана...Кто-то присвистнул. Кай напрягся"},
 {"speaker": "Вария", "text": "Ой, какая смелая. Только вот таких как ты здесь быстро перевоспитывают. Правда, Крис?"},
 {"name": "", "text": "Крис никак не реагирует. Проходит мимо Розари, даже не взглянув. Вария подходит к ней без под руку и они уходят"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/15.tscn")
	show_current_line()
