...
@export var next_scene_path: String = "res://scenes/levels/23.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [

 {"name": "", "text": "Розарию выпускают утром. Она выходит... и она видит, рядом стоит рей, а в его руках маленький термос"},
 {"speaker": "Рэй", "text": "Чай. С бергомотом. Ты замерзла"},
 {"speaker": "Розария", "text": "Я беру термос и спрашиваю у Рэя"},
 {"speaker": "Розария", "text": "Откуда ты знаешь?"},
 {"speaker": "Рэй", "text": "Я всегда знаю, где ты и в каком состоянии"},
