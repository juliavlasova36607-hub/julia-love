...
@export var next_scene_path: String = "res://scenes/levels/20,4.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Розария поворачивается, а сзади стоит почти вплотную Рэй. "},
 {"name": "", "text": "Рэй смотрит в глаза Розарии"},
 {"speaker": "Рэй", "text": "Твоя сборка безупречна. Ты талантлива. Не дай им сломать тебя"},
 {"name": "", "text": "Он уходит"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/20,3.tscn")
	show_current_line()
