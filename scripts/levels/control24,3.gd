...
@export var next_scene_path: String = "res://scenes/levels/25.tscn"

var dialogues = [
	{"speaker": "Кай", "text": "Никто не знает. Может её. Может нет. Но она хочет, чтобы ты думала, что да, поэтому..."},
	{"speaker": "Кай", "text": "Забей и это полная ложь"},
