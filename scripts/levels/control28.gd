...
@export var next_scene_path: String = "res://scenes/levels/28,1.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Розария и Зак стоят  у почти готового skyline"},
 {"speaker": "Розария", "text": "Тут машина опять сломалась, я сняла тут воздушный фильтр и нету антиблокировочной системы"},
 {"speaker": "Зак", "text": "Ничего страшного, сделаем не переживай"},
 {"speaker": "Зак", "text": "И это, через три дня смена караула"},
 {"speaker": "Зак", "text": "В 3:00 мост поднимают на техобслуживание на 15 минут"}, 
 {"speaker": "Зак", "text": "Мы может проскочить"},
 {"speaker": "Розария", "text": "А Крис?"},
 {"speaker": "Зак", "text": "А что Крис? Он остаётся. Или ты возьмёшь его с собой?"},
