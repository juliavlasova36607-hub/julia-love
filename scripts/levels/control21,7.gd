...
@export var next_scene_path: String = "res://scenes/levels/21,8.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"speaker": "Крис", "text": "Ты идёшь со мной"},
 {"speaker": "Розария", "text": "Я никуда с тобой не пойду. Ты мне никто"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,7.tscn")
	show_current_line()
