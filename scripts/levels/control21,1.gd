...
@export var next_scene_path: String = "res://scenes/levels/21,2.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"speaker": "Зак", "text": "Ты слишком правильная. Здесь все мануалы"},
 {"speaker": "Зак", "text": "Для слабаков"},
 {"speaker": "Розария", "text": "Я почти подошла к Заку и присела на корточки рядом с машиной, чуть облакчиваясь на неё"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,1.tscn")
	show_current_line()
