...
@export var next_scene_path: String = "res://scenes/levels/21,19.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
  
 {"name": "", "text": "Он разворачивается и уходит, не сказав больше ни слова"},
 {"speaker": "Зак", "text": "Ты как?"},
 {"speaker": "Розария", "text": "Нормально. Не переживай, давай на сегодня заканчивать с ремонтом и пошли отдыхать"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,18.tscn")
	show_current_line()
