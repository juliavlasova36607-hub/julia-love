...
@export var next_scene_path: String = "res://scenes/levels/27,2.tscn"

var dialogues = [
	{"name": "", "text": "Розария на skyline. Вечерняя гонка с Крисом на его мотоцикле "},
	{"name": "", "text": "Финишируют одновременно"},
