...
@export var next_scene_path: String = "res://scenes/levels/22,4.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [

 {"name": "", "text": "Он встаёт"},
 {"speaker": "Элиас", "text": "Терпи. Это не последний раз"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/22,3.tscn")
	show_current_line()
