...
@export var next_scene_path: String = "res://scenes/levels/21,13.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "выгнала skyline на улицу, поставила рядом с гаражом. Подходит Крис "},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,12.tscn")
	show_current_line()
