...
@export var next_scene_path: String = "res://scenes/levels/21,9.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Крис, сделал пару шагов и он уже стоит рядом с Розарией,Схватил её за подбородок, заставил смотреть в глаза"},
 {"speaker": "Крис", "text": "Ты покраснела. Только что. Когда я вошёл"},
 {"speaker": "Розария", "text": "От злости"},
 {"speaker": "Крис", "text": "Врёшь"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/21,8.tscn")
	show_current_line()
