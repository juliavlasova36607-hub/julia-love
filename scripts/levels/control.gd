...
@export var next_scene_path: String = "res://scenes/levels/2.tscn"

var dialogues = [
	{"name": "", "text": "Мое имя..."},
	{"name": "", "text": "Розария..."},
	{"name": "", "text": "Как я поняля, меня похитили, ведь я не помню как оказалась в этой академии..."},
	{"name": "", "text": "..."},
	{"name": "", "text": "...Мне было страшно"},
	{"name": "", "text": "Пока я не поняла, что с каждым днем мне нравится здесь все больше и больше..."},
]
