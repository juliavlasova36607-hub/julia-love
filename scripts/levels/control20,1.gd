...
@export var next_scene_path: String = "res://scenes/levels/20,2.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"speaker": "Адам", "text": "Смотрите, прилежная ученица старается. Думает, если будет умничать, её похвалят и отпустят."},
 {"speaker": "Адам", "text": "Глупышка. Отсюда не выходят. Только в мешке"},
 {"name": "", "text": "Розария отвечает не оборачиваясь"},
 {"speaker": "Розария", "text": "У тебя проблемы, Адам?"},
 {"speaker": "Адам", "text": "Пока нет. Но я над ними работаю"},
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/20,1.tscn")
	show_current_line()
