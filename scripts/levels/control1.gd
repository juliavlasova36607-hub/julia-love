...
@export var next_scene_path: String = "res://scenes/levels/1,1.tscn"

var dialogues = [
	{"name": "", "text": "Меня зовут Розария..."},
	{"name": "", "text": "Мне 19 и иногда я замазываю свои татуировки, и я...не помню своего прошлого... но только помню..."},
]
