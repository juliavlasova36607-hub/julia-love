...
@export var next_scene_path: String = "res://scenes/levels/15.tscn"

# Массив с диалогами (каждый элемент - словарь с именем говорящего и текстом)
var dialogue = [
 {"name": "", "text": "Розария входит. На неё смотрят. Взгляды разные: любопытсво, презрение, равнодушие "},
 {"name": "", "text": "Первый кто подходит - Кай. Широкая белая одежда. Узкие глаза. Улыбается, держа в руке шоколадку, которую начал протягивать ко  мне"},
 {"speaker": "Кай", "text": "Привет! Я Кай. Ты новенькая? Выглядишь... живой. Уже достижение "},
 {"speaker": "Розария", "text": "Я не нуждаюсь  в твоём одобрении"},
 {"speaker": "Кай", "text": "Ой, какая колючка. Ладно, я просто так. Добрых людей здесь мало."},
 {"speaker": "Кай", "text": "Думал, тебе пригодится друг"},
 {"name": "", "text": " Всё это время он держал шоколадку в руке, протягивая её всё ближе и ближе ко мне"},
 {"speaker": "Розария", "text": "...Зачем?"},
 {"speaker": "Кай", "text": "Ты не ела два дня. Я считал. У меня првычка замечать такие вещи"},
]
...
func _ready():
	GameManager.set_current_scene("res://scenes/levels/14.tscn")
	show_current_line()
