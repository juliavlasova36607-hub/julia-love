...
@export var next_scene_path: String = "res://scenes/levels/27,3.tscn"

var dialogues = [
	{"name": "", "text": "Они остановились, стоят разговарива, смеются и улыбаются"},
	{"speaker": "Розария", "text": "Круто провели время"},
	{"speaker": "Крис", "text": "Да, с тобой так хорошо"},
